//! Digital I/O
//!
//! Version 3 / fallible traits. Infallible implementations should set Error to `!`.
...
///
/// ```
/// use embedded_hal::digital::v3::{OutputPin, StatefulOutputPin, ToggleableOutputPin};
/// use embedded_hal::digital::v3::toggleable;
///
